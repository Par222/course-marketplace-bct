export const courses=[
    ...
    },
    {
      ...
      "description": "Understand basics and difficult parts of the 3 most popular frameworks - React JS, Angular and Vue. All in one course!",
    ...
    },
    {
      ...
      "description": "Understand basic and difficult parts of Vue JS 3 framework. Course is including Vue Router and latest Vue JS 3 features including Composition API.    ",
    ...
    },
    {
      ...
      "description": "Build Serverless Web Apps with Next.js. Learn Hooks. Deploy to Vercel. Next.js (Next JS 10+), React (React 16+) & Node.",
    ...
    },
    {
      ...
      "description": "Beginner to Advance Web Developer Guide. Master Angular (Angular 8+), React + Redux (React 16.12+) & Node with Mongo DB!",
    ...
    },
    {
      ...
      "description": "Learn how to create 'real world' Vue JS 2 application connected to Firestore(Firebase) Database.",
    ...
    },
    {
      ...
      "description": "Build your own Blog App with the latest Next.JS & React(Next 9.4+, React hooks). Learn how to use headless Sanity CMS.",
    ...
    },
    {
      ...
      "description": "Learn GraphQL and Apollo! Create a fast portfolio application in Next.js(Next 9+) / React backed with Apollo + Node.js",
